/* Generated by Cython 0.11.2 on Thu Mar 11 11:51:52 2010 */
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":14
 *     Lattice node class.
 *     """
 *     def __cinit__(self):             # <<<<<<<<<<<<<<
 *         self.node = NULL
...
static int __pyx_pf_12pocketsphinx_7LatNode___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":15
 *     """
 *     def __cinit__(self):
 *         self.node = NULL             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":17
 *         self.node = NULL
 * 
 *     cdef set_node(LatNode self, ps_lattice_t *dag, ps_latnode_t *node):             # <<<<<<<<<<<<<<
 *         cdef short fef, lef
...
static  PyObject *__pyx_f_12pocketsphinx_7LatNode_set_node(struct __pyx_obj_12pocketsphinx_LatNode *__pyx_v_self, ps_lattice_t *__pyx_v_dag, ps_latnode_t *__pyx_v_node) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":20
 *         cdef short fef, lef
 *         cdef ps_latlink_t *best_exit
 *         self.dag = dag             # <<<<<<<<<<<<<<
 *         self.node = node
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":21
 *         cdef ps_latlink_t *best_exit
 *         self.dag = dag
 *         self.node = node             # <<<<<<<<<<<<<<
 *         self.word = ps_latnode_word(dag, node)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":22
 *         self.dag = dag
 *         self.node = node
 *         self.word = ps_latnode_word(dag, node)             # <<<<<<<<<<<<<<
 *         self.baseword = ps_latnode_baseword(dag, node)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":23
 *         self.node = node
 *         self.word = ps_latnode_word(dag, node)
 *         self.baseword = ps_latnode_baseword(dag, node)             # <<<<<<<<<<<<<<
 *         self.sf = ps_latnode_times(node, &fef, &lef)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":24
 *         self.word = ps_latnode_word(dag, node)
 *         self.baseword = ps_latnode_baseword(dag, node)
 *         self.sf = ps_latnode_times(node, &fef, &lef)             # <<<<<<<<<<<<<<
 *         self.fef = fef
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":25
 *         self.baseword = ps_latnode_baseword(dag, node)
 *         self.sf = ps_latnode_times(node, &fef, &lef)
 *         self.fef = fef             # <<<<<<<<<<<<<<
 *         self.lef = lef
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":26
 *         self.sf = ps_latnode_times(node, &fef, &lef)
 *         self.fef = fef
 *         self.lef = lef             # <<<<<<<<<<<<<<
 *         self.best_exit = None
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":27
 *         self.fef = fef
 *         self.lef = lef
 *         self.best_exit = None             # <<<<<<<<<<<<<<
 *         best_exit = NULL
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":28
 *         self.lef = lef
 *         self.best_exit = None
 *         best_exit = NULL             # <<<<<<<<<<<<<<
 *         self.prob = sb.logmath_log_to_ln(ps_lattice_get_logmath(dag),
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":31
 *         self.prob = sb.logmath_log_to_ln(ps_lattice_get_logmath(dag),
 *                                          ps_latnode_prob(dag, node, &best_exit))
 *         if best_exit != NULL:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":33
 *         if best_exit != NULL:
 *             self.best_exit = LatLink()
 *             self.best_exit.set_link(dag, best_exit)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":35
 *             self.best_exit.set_link(dag, best_exit)
 * 
 *     def exits(self):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":52
 *         itor = LatLinkIterator()
 *         itor.itor = citor
 *         itor.dag = self.dag             # <<<<<<<<<<<<<<
 *         return itor
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":59
...
static int __pyx_pf_12pocketsphinx_15LatNodeIterator___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":60
 *     """
 *     def __cinit__(self, start, end):
 *         self.itor = NULL             # <<<<<<<<<<<<<<
 *         self.first_node = True
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":61
 *     def __cinit__(self, start, end):
 *         self.itor = NULL
 *         self.first_node = True             # <<<<<<<<<<<<<<
 *         self.start = start
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":62
 *         self.itor = NULL
 *         self.first_node = True
 *         self.start = start             # <<<<<<<<<<<<<<
 *         self.end = end
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":68
 *         return self
 * 
 *     def __next__(self):             # <<<<<<<<<<<<<<
 *         cdef LatNode node
...
static PyObject *__pyx_pf_12pocketsphinx_15LatNodeIterator___next__(PyObject *__pyx_v_self) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":74
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":75
 *         # Make sure we keep raising exceptions at the end
 *         if self.itor == NULL:
 *             raise StopIteration             # <<<<<<<<<<<<<<
 *         # Advance the iterator if this isn't the first item
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":77
 *             raise StopIteration
 *         # Advance the iterator if this isn't the first item
 *         if self.first_node:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":78
 *         # Advance the iterator if this isn't the first item
 *         if self.first_node:
 *             self.first_node = False             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":84
 *                 raise StopIteration
 *         # Look for the next node within the given time range
 *         cnode = ps_latnode_iter_node(self.itor)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":85
 *         # Look for the next node within the given time range
 *         cnode = ps_latnode_iter_node(self.itor)
 *         start = ps_latnode_times(cnode, NULL, NULL)             # <<<<<<<<<<<<<<
 *         while start < self.start or start >= self.end:
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":86
 *         cnode = ps_latnode_iter_node(self.itor)
 *         start = ps_latnode_times(cnode, NULL, NULL)
 *         while start < self.start or start >= self.end:             # <<<<<<<<<<<<<<
 *             self.itor = ps_latnode_iter_next(self.itor)
 ...
 */
  while (1) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":87
 *         start = ps_latnode_times(cnode, NULL, NULL)
 *         while start < self.start or start >= self.end:
 *             self.itor = ps_latnode_iter_next(self.itor)             # <<<<<<<<<<<<<<
 *             if self.itor == NULL:
 ...
 */
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":88
 *         while start < self.start or start >= self.end:
 *             self.itor = ps_latnode_iter_next(self.itor)
 *             if self.itor == NULL:             # <<<<<<<<<<<<<<
 *                 raise StopIteration
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":94
 *         node = LatNode()
 *         node.set_node(self.dag, cnode)
 *         return node             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":100
 *     Lattice link class.
 *     """
 *     def __cinit__(self):             # <<<<<<<<<<<<<<
 *         self.link = NULL
...
static int __pyx_pf_12pocketsphinx_7LatLink___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":101
 *     """
 *     def __cinit__(self):
 *         self.link = NULL             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":103
 *         self.link = NULL
 * 
 *     cdef set_link(LatLink self, ps_lattice_t *dag, ps_latlink_t *link):             # <<<<<<<<<<<<<<
 *         cdef short sf
...
static  PyObject *__pyx_f_12pocketsphinx_7LatLink_set_link(struct __pyx_obj_12pocketsphinx_LatLink *__pyx_v_self, ps_lattice_t *__pyx_v_dag, ps_latlink_t *__pyx_v_link) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":105
 *     cdef set_link(LatLink self, ps_lattice_t *dag, ps_latlink_t *link):
 *         cdef short sf
 *         self.dag = dag             # <<<<<<<<<<<<<<
 *         self.link = link
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":106
 *         cdef short sf
 *         self.dag = dag
 *         self.link = link             # <<<<<<<<<<<<<<
 *         self.word = ps_latlink_word(dag, link)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":107
 *         self.dag = dag
 *         self.link = link
 *         self.word = ps_latlink_word(dag, link)             # <<<<<<<<<<<<<<
 *         self.baseword = ps_latlink_baseword(dag, link)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":108
 *         self.link = link
 *         self.word = ps_latlink_word(dag, link)
 *         self.baseword = ps_latlink_baseword(dag, link)             # <<<<<<<<<<<<<<
 *         self.ef = ps_latlink_times(link, &sf)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":109
 *         self.word = ps_latlink_word(dag, link)
 *         self.baseword = ps_latlink_baseword(dag, link)
 *         self.ef = ps_latlink_times(link, &sf)             # <<<<<<<<<<<<<<
 *         self.sf = sf
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":119
 * 
 *         cdest = ps_latlink_nodes(self.link, &csrc)
 *         src = LatNode()             # <<<<<<<<<<<<<<
 *         src.set_node(self.dag, csrc)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":131
 *         cpred = ps_latlink_pred(self.link)
 *         if cpred == NULL:
 *             return None             # <<<<<<<<<<<<<<
 *         pred = LatLink()
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":133
 *             return None
 *         pred = LatLink()
 *         pred.set_link(self.dag, cpred)             # <<<<<<<<<<<<<<
 *         return pred
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":134
 *         pred = LatLink()
 *         pred.set_link(self.dag, cpred)
 *         return pred             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":140
 *     Iterator over word lattice nodes.
 *     """
 *     def __cinit__(self):             # <<<<<<<<<<<<<<
 *         self.itor = NULL
...
static int __pyx_pf_12pocketsphinx_15LatLinkIterator___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":141
 *     """
 *     def __cinit__(self):
 *         self.itor = NULL             # <<<<<<<<<<<<<<
 *         self.first_link = True
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":142
 *     def __cinit__(self):
 *         self.itor = NULL
 *         self.first_link = True             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":144
 *         self.first_link = True
 * 
 *     def __iter__(self):             # <<<<<<<<<<<<<<
 *         return self
...
static PyObject *__pyx_pf_12pocketsphinx_15LatLinkIterator___iter__(PyObject *__pyx_v_self) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":145
 * 
 *     def __iter__(self):
 *         return self             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_12pocketsphinx_15LatLinkIterator___next__(PyObject *__pyx_v_self) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":149
 *     def __next__(self):
 *         cdef LatLink link
 *         if self.first_link:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":152
 *             self.first_link = False
 *         else:
 *             self.itor = ps_latlink_iter_next(self.itor)             # <<<<<<<<<<<<<<
 *         if self.itor == NULL:
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":153
 *         else:
 *             self.itor = ps_latlink_iter_next(self.itor)
 *         if self.itor == NULL:             # <<<<<<<<<<<<<<
 *             raise StopIteration
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":154
 *             self.itor = ps_latlink_iter_next(self.itor)
 *         if self.itor == NULL:
 *             raise StopIteration             # <<<<<<<<<<<<<<
 *         link = LatLink()
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":163
 *     PocketSphinx word lattice class.
 *     """
...
static int __pyx_pf_12pocketsphinx_7Lattice___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":165
 *     def __cinit__(self, ps=None, latfile=None, boxed=None):
 *         cdef Decoder decoder
 *         self.dag = NULL             # <<<<<<<<<<<<<<
 *         if ps and latfile:
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":166
 *         cdef Decoder decoder
 *         self.dag = NULL
 *         if ps and latfile:             # <<<<<<<<<<<<<<
 *             decoder = ps
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":167
 *         self.dag = NULL
 *         if ps and latfile:
 *             decoder = ps             # <<<<<<<<<<<<<<
 *             self.dag = ps_lattice_read(decoder.ps, latfile)
 ...
 */
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":168
 *         if ps and latfile:
 *             decoder = ps
 *             self.dag = ps_lattice_read(decoder.ps, latfile)             # <<<<<<<<<<<<<<
 *             if self.dag == NULL:
 ...
 */
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":169
 *             decoder = ps
 *             self.dag = ps_lattice_read(decoder.ps, latfile)
 *             if self.dag == NULL:             # <<<<<<<<<<<<<<
 *                 raise RuntimeError, "Failed to read lattice from %s" % latfile
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":170
 *             self.dag = ps_lattice_read(decoder.ps, latfile)
 *             if self.dag == NULL:
 *                 raise RuntimeError, "Failed to read lattice from %s" % latfile             # <<<<<<<<<<<<<<
 *         if boxed: self.set_boxed(boxed)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":171
 *             if self.dag == NULL:
 *                 raise RuntimeError, "Failed to read lattice from %s" % latfile
 *         if boxed: self.set_boxed(boxed)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":173
 *         if boxed: self.set_boxed(boxed)
 * 
 *     cdef set_dag(Lattice self, ps_lattice_t *dag):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":182
 *         cdef ps_lattice_t *dag
 *         dag = <ps_lattice_t *>(<PyGBoxed *>box).boxed
 *         ps_lattice_retain(dag)             # <<<<<<<<<<<<<<
 *         ps_lattice_free(self.dag)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":183
 *         dag = <ps_lattice_t *>(<PyGBoxed *>box).boxed
 *         ps_lattice_retain(dag)
 *         ps_lattice_free(self.dag)             # <<<<<<<<<<<<<<
 *         self.dag = dag
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":184
 *         ps_lattice_retain(dag)
 *         ps_lattice_free(self.dag)
 *         self.dag = dag             # <<<<<<<<<<<<<<
 *         self.n_frames = ps_lattice_n_frames(self.dag)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":185
 *         ps_lattice_free(self.dag)
 *         self.dag = dag
 *         self.n_frames = ps_lattice_n_frames(self.dag)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":187
 *         self.n_frames = ps_lattice_n_frames(self.dag)
 * 
 *     def __dealloc__(self):             # <<<<<<<<<<<<<<
 *         ps_lattice_free(self.dag)
...
static void __pyx_pf_12pocketsphinx_7Lattice___dealloc__(PyObject *__pyx_v_self) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":188
 * 
 *     def __dealloc__(self):
 *         ps_lattice_free(self.dag)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":190
 *         ps_lattice_free(self.dag)
 * 
 *     def bestpath(self, NGramModel lmset, float lwf, float ascale):             # <<<<<<<<<<<<<<
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":198
 *         return link
 * 
 *     def posterior(self, NGramModel lmset, float ascale):             # <<<<<<<<<<<<<<
 *         cdef logmath_t *lmath
...
static PyObject *__pyx_pf_12pocketsphinx_7Lattice_posterior(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":200
 *     def posterior(self, NGramModel lmset, float ascale):
 *         cdef logmath_t *lmath
 *         lmath = ps_lattice_get_logmath(self.dag)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":201
 *         cdef logmath_t *lmath
 *         lmath = ps_lattice_get_logmath(self.dag)
 *         return sb.logmath_log_to_ln(lmath,             # <<<<<<<<<<<<<<
 *                                     ps_lattice_posterior(self.dag, lmset.lm, ascale))
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":208
 * 
 *         if end == -1:
 *             end = ps_lattice_n_frames(self.dag)             # <<<<<<<<<<<<<<
 *         itor = LatNodeIterator(start, end)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":210
 *             end = ps_lattice_n_frames(self.dag)
 *         itor = LatNodeIterator(start, end)
 *         itor.dag = self.dag             # <<<<<<<<<<<<<<
 *         itor.itor = ps_latnode_iter(self.dag)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":211
 *         itor = LatNodeIterator(start, end)
 *         itor.dag = self.dag
 *         itor.itor = ps_latnode_iter(self.dag)             # <<<<<<<<<<<<<<
 *         return itor
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":212
 *         itor.dag = self.dag
 *         itor.itor = ps_latnode_iter(self.dag)
 *         return itor             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":214
 *         return itor
 * 
 *     def write(self, outfile):             # <<<<<<<<<<<<<<
 *         cdef int rv
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":219
 *         rv = ps_lattice_write(self.dag, outfile)
 *         if rv < 0:
 *             raise RuntimeError, "Failed to write lattice to %s" % outfile             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":233
 *                              beam='1e-80')
 *     """
...
static int __pyx_pf_12pocketsphinx_7Decoder___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":238
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":239
 *         # Construct from an existing GObject pointer if given
 *         if 'boxed' in kwargs:
 *             self.argc = 0             # <<<<<<<<<<<<<<
 *             self.set_boxed(kwargs['boxed'])
 ...
 */
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":240
 *         if 'boxed' in kwargs:
 *             self.argc = 0
 *             self.set_boxed(kwargs['boxed'])             # <<<<<<<<<<<<<<
 *             return
 ...
 */
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":241
 *             self.argc = 0
 *             self.set_boxed(kwargs['boxed'])
 *             return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":244
 * 
 *         # A much more concise version of what pocketsphinx_parse_argdict used to do
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":245
 *         # A much more concise version of what pocketsphinx_parse_argdict used to do
 *         self.argc = len(kwargs) * 2
 *         self.argv = <char **>sb.ckd_calloc(self.argc, sizeof(char *))             # <<<<<<<<<<<<<<
 *         i = 0
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":246
 *         self.argc = len(kwargs) * 2
 *         self.argv = <char **>sb.ckd_calloc(self.argc, sizeof(char *))
 *         i = 0             # <<<<<<<<<<<<<<
 *         for k, v in kwargs.iteritems():
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":247
 *         self.argv = <char **>sb.ckd_calloc(self.argc, sizeof(char *))
 *         i = 0
 *         for k, v in kwargs.iteritems():             # <<<<<<<<<<<<<<
 *             if k[0] != '-':
 ...
 */
  ...
  for (;;) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":248
 *         i = 0
 *         for k, v in kwargs.iteritems():
 *             if k[0] != '-':             # <<<<<<<<<<<<<<
 *                 k = '-' + k
 ...
 */
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":250
 *             if k[0] != '-':
 *                 k = '-' + k
 *             self.argv[i] = sb.ckd_salloc(k)             # <<<<<<<<<<<<<<
 *             self.argv[i+1] = sb.ckd_salloc(v)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":258
 *         self.ps = ps_init(config)
 *         if self.ps == NULL:
 *             raise RuntimeError, "Failed to initialize PocketSphinx"             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":264
 *         ps = <ps_decoder_t *>(<PyGBoxed *>box).boxed
 *         ps_retain(ps)
 *         ps_free(self.ps)             # <<<<<<<<<<<<<<
 *         self.ps = ps
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":272
 *             sb.ckd_free(self.argv[i])
 *         sb.ckd_free(self.argv)
 *         self.argv = NULL             # <<<<<<<<<<<<<<
 *         self.argc = 0
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":275
 *         self.argc = 0
 * 
 *     def decode_raw(self, fh, uttid=None, maxsamps=-1):             # <<<<<<<<<<<<<<
 *         cdef FILE *cfh
...
static PyObject *__pyx_pf_12pocketsphinx_7Decoder_decode_raw(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":280
 *         cdef char *cuttid
 * 
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":281
 * 
 *         cfh = PyFile_AsFile(fh)
 *         if uttid == None:             # <<<<<<<<<<<<<<
 *             cuttid = NULL
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":282
 *         cfh = PyFile_AsFile(fh)
 *         if uttid == None:
 *             cuttid = NULL             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":284
 *             cuttid = NULL
 *         else:
 *             cuttid = uttid             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":285
 *         else:
 *             cuttid = uttid
 *         return ps_decode_raw(self.ps, cfh, cuttid, maxsamps)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":287
 *         return ps_decode_raw(self.ps, cfh, cuttid, maxsamps)
 * 
 *     def start_utt(self, uttid=None):             # <<<<<<<<<<<<<<
 *         cdef char *cuttid
...
static PyObject *__pyx_pf_12pocketsphinx_7Decoder_start_utt(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":290
 *         cdef char *cuttid
 * 
 *         if uttid == None:             # <<<<<<<<<<<<<<
 *             cuttid = NULL
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":291
 * 
 *         if uttid == None:
 *             cuttid = NULL             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":293
 *             cuttid = NULL
 *         else:
 *             cuttid = uttid             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":294
 *         else:
 *             cuttid = uttid
 *         if ps_start_utt(self.ps, cuttid) < 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError, "Failed to start utterance processing"
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":295
 *             cuttid = uttid
 *         if ps_start_utt(self.ps, cuttid) < 0:
 *             raise RuntimeError, "Failed to start utterance processing"             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":297
 *             raise RuntimeError, "Failed to start utterance processing"
 * 
 *     def process_raw(self, data, no_search=False, full_utt=False):             # <<<<<<<<<<<<<<
 *         cdef Py_ssize_t len
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":305
 *             raise RuntimeError, "Failed to process %d samples of audio data" % len
 * 
 *     def ps_end_utt(self):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":307
 *     def ps_end_utt(self):
 *         if ps_end_utt(self.ps) < 0:
 *             raise RuntimeError, "Failed to stop utterance processing"             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":309
 *             raise RuntimeError, "Failed to stop utterance processing"
 * 
 *     def get_hyp(self):             # <<<<<<<<<<<<<<
 *         cdef char *hyp, *uttid
...
static PyObject *__pyx_pf_12pocketsphinx_7Decoder_get_hyp(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":313
 *         cdef int score
 * 
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":314
 * 
 *         hyp = ps_get_hyp(self.ps, &score, &uttid)
 *         return hyp, uttid, score             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":316
 *         return hyp, uttid, score
 * 
 *     def get_lattice(self):             # <<<<<<<<<<<<<<
 *         cdef ps_lattice_t *dag
...
static PyObject *__pyx_pf_12pocketsphinx_7Decoder_get_lattice(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":320
 *         cdef Lattice lat
 * 
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":321
 * 
 *         dag = ps_get_lattice(self.ps)
 *         if dag == NULL:             # <<<<<<<<<<<<<<
 *             raise RuntimeError, "Failed to create word lattice"
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":322
 *         dag = ps_get_lattice(self.ps)
 *         if dag == NULL:
 *             raise RuntimeError, "Failed to create word lattice"             # <<<<<<<<<<<<<<
 *         lat = Lattice()
...
static PyObject *__pyx_pf_12pocketsphinx_7Decoder_get_lmset(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":334
 *         cdef int wip, uw
 * 
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":335
 * 
 *         clm = ps_get_lmset(self.ps)
 *         lm = NGramModel()             # <<<<<<<<<<<<<<
 *         lm.set_lm(clm)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":336
 *         clm = ps_get_lmset(self.ps)
 *         lm = NGramModel()
 *         lm.set_lm(clm)             # <<<<<<<<<<<<<<
 *         lmath = sb.logmath_retain(ps_get_logmath(self.ps))
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":337
 *         lm = NGramModel()
 *         lm.set_lm(clm)
 *         lmath = sb.logmath_retain(ps_get_logmath(self.ps))             # <<<<<<<<<<<<<<
 *         lm.set_lmath(lmath)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":338
 *         lm.set_lm(clm)
 *         lmath = sb.logmath_retain(ps_get_logmath(self.ps))
 *         lm.set_lmath(lmath)             # <<<<<<<<<<<<<<
 *         config = ps_get_config(self.ps)
 ...
 */
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":339
 *         lmath = sb.logmath_retain(ps_get_logmath(self.ps))
 *         lm.set_lmath(lmath)
 *         config = ps_get_config(self.ps)             # <<<<<<<<<<<<<<
 *         # This is not necessarily true but it will have to do
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":346
 *         return lm
 * 
 *     def add_word(self, word, phones, update=True):             # <<<<<<<<<<<<<<
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":349
 *         return ps_add_word(self.ps, word, phones, update)
 * 
 *     def load_dict(self, dictfile, fdictfile=None, format=None):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_12pocketsphinx_7Decoder_load_dict(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":350
 * 
 *     def load_dict(self, dictfile, fdictfile=None, format=None):
 *         return ps_load_dict(self.ps, dictfile, fdictfile, format)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":352
 *         return ps_load_dict(self.ps, dictfile, fdictfile, format)
 * 
 *     def save_dict(self, dictfile, format=None):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_12pocketsphinx_7Decoder_save_dict(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/trunk/pocketsphinx/python/pocketsphinx.pyx":353
 * 
 *     def save_dict(self, dictfile, format=None):
 *         return ps_save_dict(self.ps, dictfile, format)             # <<<<<<<<<<<<<<
 */
